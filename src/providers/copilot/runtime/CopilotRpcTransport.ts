...
import type { JsonRpcError } from './copilotAcpTypes';
import type { CopilotCliProcess } from './CopilotCliProcess';
...
export class CopilotRpcTransport {
  private nextId = 1;
  ...
  constructor(private readonly proc: CopilotCliProcess) {}
  ...
  start(): void {
    ...
    this.proc.onExit(() => {
      this.rejectAllPending(new Error('Copilot ACP process exited'));
    });
  }
